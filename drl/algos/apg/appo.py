...
from drl.algos.base import AveragePolicyGradientAlgo, OptInfo
    ...
    def optimize_agent(self, itr, samples):
        ...
        for _ in range(self.epochs):
            for idxs in iterate_mb_idxs(batch_size, mb_size, shuffle=True):
                ...
                loss, entropy, perplexity = self.loss(*loss_inputs[T_idxs, B_idxs], rnn_state)
                loss.backward()
