...
import torch
from drl.algos.apg.utils import discount_return, generalized_advantage_estimation
from rlpyt.algos.base import RlAlgorithm
from rlpyt.algos.utils import valid_from_done

# Convention: traj_info fields CamelCase, opt_info fields lowerCamelCase
OptInfo = namedtuple("OptInfo", ["pLoss", "vLoss", "gradNorm", "entropy", "perplexity", "eta", "valueBias"])
...
class AveragePolicyGradientAlgo(RlAlgorithm):
    ...
    def process_returns(self, reward, samples):
        """
        ...
        done, value, bv = (samples.env.done, samples.agent.agent_info.value, samples.agent.bootstrap_value)
